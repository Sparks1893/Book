...
class Bookhive {
    ...
    /**
     * Load systems + register shortcodes
     */
    public function init() {
        $this->load_includes();

        // Register shortcode for the main dashboard
        add_shortcode('bookhive_dashboard', [$this, 'render_dashboard']);
    }

    /**
     * Auto-include all PHP files inside /includes/
     */
    ...
    /**
     * Enqueue global plugin styles & scripts
     */
    public function enqueue_assets() {

        // FRONTEND & ADMIN CORE CSS
        wp_enqueue_style(
            'bookhive-core',
            BOOKHIVE_URL . 'assets/css/bookhive-core.css',
            [],
            BOOKHIVE_VERSION
        );
        ...
        wp_enqueue_script(
            'bookhive-core',
            BOOKHIVE_URL . 'assets/js/bookhive-core.js',
            ['jquery'],
            BOOKHIVE_VERSION,
            true
        );

        // Pass AJAX + security nonce
    ...
    public function render_dashboard() {
        ...
        <div class="bookhive-dashboard">
            ...
            <!-- EXAMPLE GRID (will later be dynamic user data) -->
...
// -----------------------------------------------------------------------------
// ACHIEVEMENTS SCRIPT LOADER (NOW FIXED)
// -----------------------------------------------------------------------------
